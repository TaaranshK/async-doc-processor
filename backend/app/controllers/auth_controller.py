...
async def register_user(payload: RegisterRequest, db: DbSession) -> UserResponse:
...
async def refresh(payload: RefreshRequest) -> TokenResponse:
    # For simplicity, treat refresh token as another JWT and issue new tokens.
    # Client should store/rotate tokens.
