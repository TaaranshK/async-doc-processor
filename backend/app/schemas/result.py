...
class ExtractedFields(BaseModel):
    # The fields that the AI extracted from a document
    # All fields are optional because we might not find everything
...
class ResultResponse(BaseModel):
    ...
    reviewed_output:  ExtractedFields
    is_finalized:     bool
...
class ReviewedOutputUpdate(BaseModel):
    # Data the user sends to update the reviewed output fields
